...
{/* title and form */}
      <View className="h-full w-full flex justify-around  pb-25">
        ...
        <View className="flex items-center mx-4 space-y-4 ">
          ...
          {/* form */}
          <Animated.View entering={FadeInDown.delay(1200).duration(1000).springify()} className="bg-white p-5 rounded-2xl w-full mb-3">
          ...
          <Animated.View entering={FadeInDown.delay(1400).duration(1000).springify()} className="bg-white p-5 rounded-2xl w-full mb-3">
         ...
         <Animated.View entering={FadeInDown.delay(1800).duration(1000).springify()}  className=" flex-row justify-center">
          <Text>Don't have an account? </Text>
          <TouchableOpacity onPress={()=>navigation.navigate('Signup')}>
            <Text className="text-rose-700">SignUp</Text>
          </TouchableOpacity>
